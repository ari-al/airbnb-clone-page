...
function Header() {
    return(
        <header style={{height: "80px"}}>
            <div style={{paddingLeft: "80px", paddingRight: "80px", margin: "0", position: "relative", display: "flex"}}>
                <div>
                    <a href="/" style={{display: "inline-flex", height: "80px", position: "relative", verticalAlign: "middle", color: "#FFFFFF", alignItems: "center"}}>
                ...
                <div style={{ flex: "0 1 auto", minWidth: "348px", padding: "0 24px"}}>
                    <div style={{ display: "flex", alignItems: "center", position: "absolute", width: "100%", left: "0px"}} >
                ...
                <div style={{width: "100%"}}>
                    <div style={{ display: "flex", flexDirection: "row-reverse", height: "100%"}}>
                        <div style={{ display: "flex", alignItems: "center"}}>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                <div>
                                    <a href="/" style={{ fontSize: "14px", fontWeight: "600", lineHeight: "18px", color: "#FFFFFF", textDecoration:"none", padding: "12px", display: "flex"}}>
                                        <div> 호스트 되기 </div>
                                    </a>
                                </div>  
                            </div>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                <div>
                                    <div>
                                        <a href="/" style={{ fontSize: "14px", fontWeight: "600", lineHeight: "18px", color: "#FFFFFF", textDecoration:"none", padding: "12px", display: "flex"}}>
                                            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" style={{display: "block", height: "16px", width: "16px", fill: "currentcolor"}}><path d="m8.002.25a7.77 7.77 0 0 1 7.748 7.776 7.75 7.75 0 0 1 -7.521 7.72l-.246.004a7.75 7.75 0 0 1 -7.73-7.513l-.003-.245a7.75 7.75 0 0 1 7.752-7.742zm1.949 8.5h-3.903c.155 2.897 1.176 5.343 1.886 5.493l.068.007c.68-.002 1.72-2.365 1.932-5.23zm4.255 0h-2.752c-.091 1.96-.53 3.783-1.188 5.076a6.257 6.257 0 0 0 3.905-4.829zm-9.661 0h-2.75a6.257 6.257 0 0 0 3.934 5.075c-.615-1.208-1.036-2.875-1.162-4.686l-.022-.39zm1.188-6.576-.115.046a6.257 6.257 0 0 0 -3.823 5.03h2.75c.085-1.83.471-3.54 1.059-4.81zm2.262-.424c-.702.002-1.784 2.512-1.947 5.5h3.904c-.156-2.903-1.178-5.343-1.892-5.494l-.065-.007zm2.28.432.023.05c.643 1.288 1.069 3.084 1.157 5.018h2.748a6.275 6.275 0 0 0 -3.929-5.068z"></path></svg>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                <button style={{ background: "transparent", border: "1px solid #DDDDDD", color: "#222222", alignItems: "center", backgroundColor: "#FFFFFF", borderRadius: "21px", height: "42px", position: "relative", verticalAlign: "middle", padding: "5px 5px 5px 12px", display: "flex" }}>
                                    <div>
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{display: "block", fill: "none", height: "16px", width: "16px", stroke: "currentcolor", strokeWidth: "3", overflow: "visible"}}><g fill="none" fill-rule="nonzero"><path d="m2 16h28"></path><path d="m2 24h28"></path><path d="m2 8h28"></path></g></svg>
                                    </div>
                                    <div style={{height: "30px", marginLeft: "12px", width: "30px"}}>
